...
// `plane' class
template<class T> class plane : public shape<T>
{
private:
...
/* ---------- init ---------- */
template<class T> void plane<T>::init(const std::valarray<T>& nm, const std::valarray<T>& ze)
{
...
/* ---------- init ---------- */
template<class T> inline void plane<T>::init(const std::valarray<T>* pt1, const std::valarray<T>* pt2, const std::valarray<T>* pt3)
{
...
/* ---------- plane ---------- */
template<class T> inline plane<T>::plane(const std::valarray<T>& nm, const std::valarray<T>& ze)
{
	this->init(nm, ze);
}
...
/* ---------- plane ---------- */
template<class T> inline plane<T>::plane(const std::valarray<T>* pt1, const std::valarray<T>* pt2, const std::valarray<T>* pt3)
{
...
/* ---------- dim ---------- */
template<class T> inline unsigned short plane<T>::dim() const
{
...
/* ---------- print ---------- */
template<class T> std::string plane<T>::print() const
{
...
/* ---------- normal_p ---------- */
template<class T> inline const std::valarray<T>* plane<T>::normal_p() const
{
	return &(this->normal_);
}
...
/* ---------- zero ---------- */
template<class T> inline std::valarray<T> plane<T>::zero() const
{
	return this->zero_;
}
...
/* ---------- drop ---------- */
template<class T> inline std::valarray<T> plane<T>::drop(const std::valarray<T>& pt) const
{
...
/* ---------- distance_p ---------- */
template<class T> inline T plane<T>::distance_p(const std::valarray<T>* pt) const
{
...
/* ---------- closest ---------- */
template<class T> inline std::valarray<T> plane<T>::closest(const std::valarray<T>& pt) const
{
	return this->drop(pt);
}
...
/* ---------- contains_p ---------- */
template<class T> inline bool plane<T>::contains_p(const std::valarray<T>* pt) const
{
...
/* ---------- intersect ---------- */
template<class T> T plane<T>::intersect(const line<T>& l, std::valarray<T>& intercept, bool& parallel) const
{
	intercept.resize(0);
	parallel = false;
	if ( this->dim() != l.dim() )
