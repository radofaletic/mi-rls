...
public:
  ...
  Matrix(const size_t&, const size_t&, const std::valarray<T>&);

  Matrix(const size_t&);

  Matrix(const size_t&, const size_t&, const T& = T(0));

  void init(const size_t&, const T& = T(1));

  void init(const size_t&, const size_t&, const T& = T(0));
...
/* ---------- Matrix ---------- */
template<class T>
Matrix<T>::Matrix(const size_t& rows, const size_t& cols, const std::valarray<T>& data)
{
...
/* ---------- Matrix ---------- */
template<class T>
Matrix<T>::Matrix(const size_t& sz)
{
  this->init(sz);
}
/* ---------------------------- */
...
Matrix<T>::init(const size_t& sz, const T& init_value)
{
  if ( !sz )
    {
      this->clear();
...
/* ---------- init ---------- */
template<class T> void
Matrix<T>::init(const size_t& rows, const size_t& cols, const T& init_value)
{
  if ( !rows || !cols )
    {
      this->clear();
...
Matrix<T>::print(const bool& CSV) const
{
...
Matrix<T>::write(const std::string& filename, const dataformat& format) const
{
  std::valarray<T> b(0);
...
Matrix<T>::write(const std::string& filename, const std::valarray<T>& b, const dataformat& format) const
{
...
/* ---------- read ---------- */
template<class T> inline bool
Matrix<T>::read(const std::string& filename, const dataformat& format)
{
  std::valarray<T> b(0);
...
/* ---------- read ---------- */
template<class T> bool
Matrix<T>::read(const std::string& filename, std::valarray<T>& b, const dataformat& format)
{
...
Matrix<T>::operator()(const size_t& position)
{
...
/* ---------- operator() ---------- */
template<class T> inline T
Matrix<T>::operator()(const size_t& position) const
{
  return this->data_[position];
}
/* -------------------------------- */
...
/* ---------- operator() ---------- */
template<class T> inline T&
Matrix<T>::operator()(const size_t& row, const size_t& col)
{
...
/* ---------- operator() ---------- */
template<class T> inline T
Matrix<T>::operator()(const size_t& row, const size_t& col) const
{
  return this->data_[(row * (this->cols_)) + col];
}
/* -------------------------------- */
...
Matrix<T>::operator[](const std::slice& tsl) const
{
...
/* ---------- AddRow ---------- */
template<class T> void
Matrix<T>::AddRow(const std::valarray<T>& value)
{
...
/* ---------- AddDiagonal ---------- */
template<class T> void
Matrix<T>::AddDiagonal(const T& value)
{
  std::valarray<T> tmp = this->data_;
...
Matrix<T>::operator*(const std::valarray<T>& v) const
{
